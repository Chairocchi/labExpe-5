<?php
	...
	if(isset($_POST['save'])) {
		...
		if($sr['balance']>0) {
			$sql = "insert into fees_transaction(stdid,submitdate,transaction_remark,paid) values('$sid','$submitdate','$transaction_remark','$paid') ";
			$conn->query($sql);
	...
	<body>
					...
					<nav class="navbar-default navbar-side" role="navigation">
						<div class="sidebar-collapse">
							<ul class="nav" id="main-menu">
								...
								<li><a class="active-menu" href="fees.php"><i class="fa fa-usd "></i>Fees</a></li>
		  ...
		  <div class="form-group">
			...
			<select  class="form-control" id="branch" name="branch" >
				<option value="" >Select Branch</option>
											<?php                          // view from table
											$sql = "select * from branch where branch='1' & delete_status='0' order by branch.branch asc";
											$q = $conn->query($sql);
		...
		*/
		...
		display:none;
			...
			<div id="footer-sec">
				<p class="credits">Normalis Novum University | Brought To You By : <a href="https://github.com/Chairocchi">Allen Garcia <span class="love">❤</span></p>
			</div>
