<?php
	...
	if(isset($_POST['save'])) {
		...
		if($_POST['action']=="add") {
			...
			$q1 = $conn->query("INSERT INTO student (name,joindate,contact,about,emailid,branch,balance,fees) 
			VALUES ('$name','$joindate','$contact','$about','$emailid','$branch','$balance','$fees')") ;
	...
	if(isset($_REQUEST['act']) && @$_REQUEST['act']=="1") {
		$errormsg = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' 
		aria-label='close'>&times;</a><strong>Success!</strong> Student Add successfully</div>";
	
	} else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2") {
		$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' 
		aria-label='close'>&times;</a> <strong>Success!</strong> Student Edit successfully</div>";
	
	} else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3") {
		$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' 
		aria-label='close'>&times;</a><strong>Success!</strong> Student Delete successfully</div>";
							...
							<table class="table table-striped table-bordered table-hover" id="tSortable22">
								...
								<tbody>
									<?php    // This is the view table
										$sql = "select * from student where branch= '2' & delete_status='0'";
										$q = $conn->query($sql);
										$i=1;
										while($r = $q->fetch_assoc())
										{
